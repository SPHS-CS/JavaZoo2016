public class Totoro extends Animal implements Walking, Flying, CatBus
{
    private String toy;
    ...
    @Override
    public String catBus()
    {
        return "A Catbus appears out of nowhere, Totoro gets on and the Catbus flies away....";
    }
